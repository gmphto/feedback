...
Issue #5 establishes actor-owned projects, complete nested parent checks, scoped read/list/name-update APIs and optimistic concurrency. Project creation remains an internal command; public creation, richer fields and UI belong to subsequent issues.
